...
public class ResourceServlet {
	...
	public Response create(@QueryParam("id") Long id,@FormParam("appname")String appname,@FormParam("anstname")String anstname,
			@FormParam("compdate")String compdate,@FormParam("comptime")String comptime,@FormParam("appstatus")String appstatus)
			throws Exception {
				...
				String idString = id == null ? null : id.toString();
				JsonObject resultObject = create(db, idString, appname, anstname,compdate,comptime,appstatus);
		...
		protected JsonObject create(Database db, String id, String appname, String anstname,
					String compdate,String comptime,String appstatus)
					throws IOException {*/
		...
		/*	data.put("Application_Name", appname);
			...
			data.put("Completion_Date", compdate);
			data.put("Completion_Time", comptime);
